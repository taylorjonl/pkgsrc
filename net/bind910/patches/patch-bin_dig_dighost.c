...
--- bin/dig/dighost.c.orig	2015-08-15 00:28:49.000000000 +0000
+++ bin/dig/dighost.c
@@ -4676,7 +4676,7 @@ prepare_lookup(dns_name_t *name)
 		isc_result_t result;
 		isc_region_t r;
...
@@ -4690,7 +4690,7 @@ prepare_lookup(dns_name_t *name)
...
@@ -4719,7 +4719,7 @@ prepare_lookup(dns_name_t *name)
...
+				   dns_rdatatype_any, &isc_true);
 	if (result != ISC_R_SUCCESS) {
 		printf("\n;; NS RRset is missing to continue validation:"
 		       " FAILED\n\n");
@@ -5200,7 +5200,7 @@ sigchase_td(dns_message_t *msg)
 	isc_result_t result;
...
@@ -5223,7 +5223,7 @@ sigchase_td(dns_message_t *msg)
 			initialization(name);
 			return;
 		}
-		have_answer = true;
...
@@ -5344,7 +5344,7 @@ sigchase_td(dns_message_t *msg)
 						   dns_rdatatype_rrsig,
 						   current_lookup
 						   ->rdtype_sigchase,
-						   &true);
...
@@ -5357,7 +5357,7 @@ sigchase_td(dns_message_t *msg)
...
+						   &isc_true);
 			if (result == ISC_R_FAILURE) {
 				printf("\n;; RRSIG is missing  to continue"
 				       " validation SHOULD NOT APPEND:"
@@ -5433,7 +5433,7 @@ sigchase_td(dns_message_t *msg)
 					   &chase_authority_name,
 					   dns_rdatatype_rrsig,
 					   dns_rdatatype_ds,
-					   &true);
+					   &isc_true);
 		if (result != ISC_R_SUCCESS) {
 			printf("\n;; DSset is missing to continue validation:"
 			       " FAILED\n\n");
@@ -5521,7 +5521,7 @@ sigchase_td(dns_message_t *msg)
...
@@ -5564,7 +5564,7 @@ getneededrr(dns_message_t *msg)
 	dns_name_t *name = NULL;
...
+	isc_boolean_t   isc_true = ISC_TRUE;
 	...
 	if ((result = dns_message_firstname(msg, DNS_SECTION_ANSWER))
 	    != ISC_R_SUCCESS) {
@@ -5580,7 +5580,7 @@ getneededrr(dns_message_t *msg)
...
@@ -5699,7 +5699,7 @@ getneededrr(dns_message_t *msg)
