...
Fix SunOS privileges support as per
illumos/illumos-userland/blob/master/components/quagga/patches/75-privs-basicprivset.patch

--- lib/privs.c.orig	2013-07-30 14:47:01.000000000 +0000
+++ lib/privs.c
@@ -2,7 +2,7 @@
  * Zebra privileges.
  *
